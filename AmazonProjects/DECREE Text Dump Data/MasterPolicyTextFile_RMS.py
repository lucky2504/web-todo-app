    ...
    for rule in rules:
        ...
        for attr, attr_str in zip(attributes, attribute_strings):
            ...
            for line in lines[number_of_output_cols:]:
                line = line.strip()
                if attr_str in line:
                    attr_value.append(line.replace(attr_str, ""))
            attribute_value = ' \n'.join(attr_value)
