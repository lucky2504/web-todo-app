    ...
    for rule in rules:
        ...
        for line in lines[1:]:
            ...
            if 'messageId |' in line:
                messageId = line.split('|')[0].strip()[:9] + line.split('|')[1].strip()
...
def create_policy_attribute_df(policy_data, attributes):
    ...
    base_columns = ['Rules', 'messageId', 'Line Count', 'Policy Text', 'Attr 0'] # Initialize new dataframe with base columns
