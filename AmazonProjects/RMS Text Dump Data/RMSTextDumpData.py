...
output_cols = ['BOX_boxClass', 'BOX_minHeight', 'BOX_minLength', 'BOX_minWidth',
               'EXPORTELIGIBILITY_globalStore', 'EXPORTELIGIBILITY_haul', 'EXPORTELIGIBILITY_globalFulfillmentNetwork', 'EXPORTELIGIBILITY_globalRemoteFulfillment','EXPORTELIGIBILITY_coreExport', 'EXPORTELIGIBILITY_haulInternational',
               'REMOVAL_donationEligible', 'REMOVAL_donationReason',
               'LABELING_batteryStatements', 'LABELING_unidStatements', 'LABELING_palletLabels', 'LABELING_packLabels',
               'MESSAGING_messageIds',
               'RETURNS_returnClass', 'RETURNS_returnClasses',
               'SEGREGATION_segregate',
               'SHIPOPTION_shipOptions', 'SHIPOPTION_restrictionAction',
               'STORAGECLASSIFICATION_dropZone', 'STORAGECLASSIFICATION_storageLevel', 'STORAGECLASSIFICATION_storageClass',
               'TRANSPORTATION_mode', 'TRANSPORTATION_shipMethodGroup', 'TRANSPORTATION_destination', 'TRANSPORTATION_tags',
               'WASTE_wasteCategories', 'WASTE_wasteCategoryType', 'WASTE_wasteType', 'WASTE_wasteStorageClass',
               'WASTEPROFILE_wasteProfiles']
output_strings = [ ' boxClass |',  ' minHeight |',  ' minLength |',  ' minWidth |',
                   ' globalStore |', ' haul |', ' globalFulfillmentNetwork |', ' globalRemoteFulfillment |',' coreExport |', ' haulInternational |',
                   ' donationEligible |',  ' donationReason |',
                   ' batteryStatements |',  ' unidStatements |', ' palletLabels |',  ' packLabels |',
                   ' messageIds |',
                   ' returnClass |',  ' returnClasses |',
                   ' segregate |',
                   ' shipOptions |',  ' restrictionAction |',
                   ' dropZone |', ' storageLevel |',  ' storageClass |',
...
attributes = ['addressTypes ', 'alcoholContent ', 'asinStatus ',
              ...
              'eu2008LabelingHazard ', 'eu2008LabelingPrecautionary ', 'eu2008LabelingRisk ', 'eu2008LabelingSafety ', 'expirationDatedProduct ', 'expired ',
              'field ', 'fba ', 'fcStorageMethod ', 'flashpoint ', 'floorRecommendation ', 'fuelType ', 'fulfillmentManagerId ', 'fulfillmentShipmentId ',
              'ghsClassificationClass ', 'ghsStatement ', 'ghsStatements ', 'glProductGroup ',
              'hazmat ', 'hazmatException ', 'hazmatProperShippingName ', 'hazmatRegulatoryPackingGroup ', 'hazmatTransportationRegulatoryClass ', 'hazmatTransportationRegulatorySubsidiaryClass ',
              'hazmatType ', 'hazmatUnitedNationsRegulatoryId ',
              'invalidOrTombstonedAsin ', 'inventoryCondition ', 'iog ', 'isCustomerReturn ', 'itemHazmatVolume ', 'itemHazmatWieght ', 'itemName ', 'itemPackageWeight ', 'itemWeight ',
              'liquidContentsDescription ', 'liquidDoubleSealed ', 'liquidPackagingType ', 'liquidVolume ', 'lithiumBatteryEnergyContent ', 'lithiumBatteryPackaging ',
              'lithiumBatteryVoltage ', 'lithiumBatteryWeight ', 'lithiumIonBatteryCount ', 'lithiumMetalBatteryCount ',
              'manufactureOnDemandId ', 'maqHardCapacityBreach ', 'maqSoftCapacityBreach ', 'marketplaceId ', 'medicineClassification ', 'memoryPresent ',
              'originCountry ', 'originPostalCode ',
              'packageLevel ', 'packageWeight ', 'packingInstruction ', 'permitted ', 'permittedModes ', 'phValue ', 'productComplianceApproved ',
              'podRecommendation ', 'powerSourceType ', 'productCategory ', 'productSubCategory ', 'productType ', 'programParticipation ', 'productExpirationType ',
              'quantity ', 'quarantined ',
              'rablIds ', 'recommendedBrowseNodes ', 'regulatedSiocOverride ', 'restrictedDestinations ', 'restrictedProductClass ',
              'sellerId ', 'sellerOptedIn ', 'shipmentOption ', 'shipperDangerousGoodsEnabled ', 'shipperTrustLevel ', 'shipperTrustScore ', 'shippingPrograms ', 'shipWithAmazon ',
              'siocCapable ', 'siteId ', 'sponsoredListingCategoryId ', 'state ', 'stateOfMatter ', 'statesOfMatter ', 'storageClass ', 'storageClasses ', 'storageClassVolumes ', 'storagePermitted ',
              'temperatureRating ', 'title ',
              'utcClassification ',
