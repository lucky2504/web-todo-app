...
NIFTY_STOCKS = [
    ...
    'MARUTI', 'SUNPHARMA', 'TITAN', 'ULTRACEMCO', 'BAJAJFINSV', 'WIPRO', 'ONGC',
    'NESTLEIND', 'NTPC', 'POWERGRID', 'ADANIPOWER', 'HCLTECH', 'COALINDIA', 'M&M',
    'GRASIM', 'ADANIPORTS', 'TATAMOTORS', 'HINDALCO', 'ADANIENT', 'TATASTEEL',
    'TECHM', 'BRITANNIA', 'CIPLA', 'DIVISLAB', 'DRREDDY', 'EICHERMOT', 'HINDUNILVR',
    'INDUSINDBK', 'JSWSTEEL', 'TATACONSUM', 'UPL', 'APOLLOHOSP', 'BAJAJ-AUTO',
    'BPCL', 'SBILIFE', 'VEDL'
]
